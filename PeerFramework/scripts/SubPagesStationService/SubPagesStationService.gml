...
function SubPageStationServiceLocalData(MyMainPage):SubPage(MyMainPage) constructor{
	...
	Draw = function(){
		...
		draw_text(10,230,$"NAT Behavior: {self._LocalStationData._Address._StationNAT == StationNAT.Unknown ? "Unknown" : (self._LocalStationData._Address._StationNAT == StationNAT.Open ? "Open" : "Dependent")}");
	}
}